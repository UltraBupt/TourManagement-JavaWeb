...
/**
 * Servlet implementation class BuffetUploadServlet
 */
@WebServlet("/BuffetUploadServlet.shxt")
public class BuffetUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("buffet_id", request.getParameter("buffet_id"));
		request.getRequestDispatcher("WEB-INF/jsp/buffet/upload.jsp").forward(request, response);
	}
