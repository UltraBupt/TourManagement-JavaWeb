...
/**
 * Servlet implementation class BusUploadServlet
 */
@WebServlet("/BusUploadServlet.shxt")
public class BusUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("bus_id", request.getParameter("bus_id"));
		request.getRequestDispatcher("WEB-INF/jsp/bus/upload.jsp").forward(request, response);
	}
