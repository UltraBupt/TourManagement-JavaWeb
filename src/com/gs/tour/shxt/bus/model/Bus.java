package com.gs.tour.shxt.bus.model;
...
public class Bus {
	...
	public String getBus_point() {
		return bus_point;
	}
	public void setBus_point(String bus_point) {
		this.bus_point = bus_point;
	}
	public Integer getBus_status() {
		return bus_status;
	}
	public void setBus_status(Integer bus_status) {
