...
/**
 * Servlet implementation class OutboundTicketUploadServlet
 */
@WebServlet("/OutboundTicketUploadServlet.shxt")
public class OutboundTicketUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("outboundTicket_id", request.getParameter("outboundTicket_id"));
		request.getRequestDispatcher("WEB-INF/jsp/outboundTicket/upload.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			outboundTicketService.upload(map);
