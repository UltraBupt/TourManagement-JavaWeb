...
/**
 * Servlet implementation class TrainUploadServlet
 */
@WebServlet("/TrainUploadServlet.shxt")
public class TrainUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("train_id", request.getParameter("train_id"));
		request.getRequestDispatcher("WEB-INF/jsp/train/upload.jsp").forward(request, response);
	}
