...
/**
 * Servlet implementation class ApartmentUploadServlet
 */
@WebServlet("/ApartmentUploadServlet.shxt")
public class ApartmentUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("apartment_id", request.getParameter("apartment_id"));
		request.getRequestDispatcher("WEB-INF/jsp/apartment/upload.jsp").forward(request, response);
	}
