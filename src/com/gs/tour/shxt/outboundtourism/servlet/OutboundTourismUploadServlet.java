...
/**
 * Servlet implementation class OutboundTourismUploadServlet
 */
@WebServlet("/OutboundTourismUploadServlet.shxt")
public class OutboundTourismUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("outboundTourism_id", request.getParameter("outboundTourism_id"));
		request.getRequestDispatcher("WEB-INF/jsp/outboundTourism/upload.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			outboundTourismService.upload(map);
