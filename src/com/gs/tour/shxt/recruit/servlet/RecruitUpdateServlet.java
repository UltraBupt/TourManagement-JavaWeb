 ...
 */
@WebServlet("/RecruitUpdateServlet.shxt")
public class RecruitUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("recruit", recruitService.queryRecruitByRecruitId(Integer.parseInt(recruit_id)));
		request.getRequestDispatcher("WEB-INF/jsp/recruit/update.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		recruit.setRecruit_id(Integer.parseInt(recruit_id));
		RecruitService recruitService=new RecruitService();
		try {
