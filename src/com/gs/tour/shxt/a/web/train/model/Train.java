package com.gs.tour.shxt.a.web.train.model;
...
public class Train {
	...
	public String getTrain_point() {
		return train_point;
	}
	public void setTrain_point(String train_point) {
		this.train_point = train_point;
	}
