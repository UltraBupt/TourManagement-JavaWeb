...
/**
 * Servlet implementation class WebBillListServlet1
 */
@WebServlet("/WebBillListServlet1.html")
public class WebBillListServlet1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/web/tour/inbound.jsp").forward(request, response);
	}
