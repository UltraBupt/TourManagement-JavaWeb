...
/**
 * Servlet implementation class WebBillListServlet
 */
@WebServlet("/WebBillListServlet.html")
public class WebBillListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/web/tour/around.jsp").forward(request, response);
	}
