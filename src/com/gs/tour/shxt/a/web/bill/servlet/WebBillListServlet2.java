...
/**
 * Servlet implementation class WebBillListServlet2
 */
@WebServlet("/WebBillListServlet2.html")
public class WebBillListServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/web/tour/outbound.jsp").forward(request, response);
	}
