...
/**
 * Servlet implementation class QuickUploadServlet
 */
@WebServlet("/QuickUploadServlet.shxt")
public class QuickUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("quick_id", request.getParameter("quick_id"));
		request.getRequestDispatcher("WEB-INF/jsp/quick/upload.jsp").forward(request, response);
	}
