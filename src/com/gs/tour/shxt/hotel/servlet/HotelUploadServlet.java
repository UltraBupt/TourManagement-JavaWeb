...
/**
 * Servlet implementation class HotelUploadServlet
 */
@WebServlet("/HotelUploadServlet.shxt")
public class HotelUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("hotel_id", request.getParameter("hotel_id"));
		request.getRequestDispatcher("WEB-INF/jsp/hotel/upload.jsp").forward(request, response);
	}
