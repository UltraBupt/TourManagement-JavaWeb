...
/**
 * Servlet implementation class VillaUploadServlet
 */
@WebServlet("/VillaUploadServlet.shxt")
public class VillaUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("villa_id", request.getParameter("villa_id"));
		request.getRequestDispatcher("WEB-INF/jsp/villa/upload.jsp").forward(request, response);
	}
