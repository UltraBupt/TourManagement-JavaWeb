...
/**
 * Servlet implementation class ChangeShipStatusServlet
 */
@WebServlet("/ChangeShipStatusServlet.shxt")
public class ChangeShipStatusServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Integer ship_status = shipService.updateStatus(Integer.parseInt(ship_id));
