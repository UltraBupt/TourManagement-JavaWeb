...
<script type="text/javascript">
	function toSub(){
		var outboundTicket_desc=$("#outboundTicket_desc").val();
		var outboundTicket_price=$("#outboundTicket_price").val();
		if(outboundTicket_desc.trim().length==0){
			alert("门票详情不能为空，请重新输入");
			return false;
		}
		if(outboundTicket_price.trim().length==0){
				...
				<div class="caption">
					<i class="fa fa-gift"></i>景点门票编辑
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="OutboundTicketUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="门票描述" name="outboundTicket_desc" id="outboundTicket_desc" value="${outboundTicket.outboundTicket_desc }">
										</div>
									</div>
								</div>
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="门票价格" name="outboundTicket_price" id="outboundTicket_price" value="${outboundTicket.outboundTicket_price }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="outboundTicket_id" name="outboundTicket_id" type="hidden" value="${outboundTicket.outboundTicket_id }"/>
								</div>
							</form>
						</div>
					</div>
