				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增签证信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="VisaAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="地址" name="visa_address" id="visa_address" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="处理日期" name="visa_date" id="visa_date" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="价格" name="visa_price" id="visa_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="入境次数" name="visa_number" id="visa_number" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="停留天数" name="visa_day" id="visa_day" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="有效期" name="visa_useful" id="visa_useful" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="添加签证信息" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
