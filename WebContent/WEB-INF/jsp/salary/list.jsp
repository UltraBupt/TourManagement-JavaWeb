...
<script type="text/javascript">
	...
	//编辑信息薪资
	function upload(salary_id){
	   var updateDialog = top.dialog({
		   title:'薪资编辑',
		   url:'SalaryUpdateServlet.shxt?salary_id='+salary_id,
		   width:600,
		   height:265,
		   onclose:function(){
			  if(this.returnValue=="success"){
			...
			<div class="portlet box red">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								<form action="SalaryListServlet.shxt" method="post" id="myForm">
									<input type="text" name="salary_number" id="salary_number" value="${querySalary.salary_number }" placeholder="请输入薪资" maxlength="15">
									<input type="text" name="position_name" id="position_name" value="${querySalary.position_name }" placeholder="请输入职位" maxlength="15">
									...
									<shxt class="btn btn-circle btn-xs red" onclick="addSalary()">添加薪资</shxt>
								</form>
								...
								<c:forEach items="${pageBean.data }" var="salary" varStatus="vs">
									<tr class="danger">
									...
									<td>
										<shxt class="btn btn-circle btn-xs red" onclick="upload(${salary.salary_id})">编辑信息</shxt><br/>
									</td>
								</tr>
								</c:forEach>
								</tbody>
