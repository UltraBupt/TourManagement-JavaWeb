...
<script type="text/javascript">
	function toSub(){
		var user_photo_url=$("#user_photo_url").val();
		if(user_photo_url.trim().length==0){
			alert("请选择头像再进行提交");
		}else{
			$("#myForm").submit();
		}
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 上传
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="UserUploadServlet.shxt" method="post" id="myForm" enctype="multipart/form-data">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													...
													<span class="fileinput-new">
														<input class="btn default btn-file" type="file" name="user_photo_url" id="user_photo_url" placeholder="请选择头像">
								...
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="上传头像" onclick="toSub()">上传头像</button>
								</div>
							</form>
