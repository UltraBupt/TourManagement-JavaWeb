...
<script type="text/javascript">
	function toSub(){
		...
		var finance_price=$("#finance_price").val();
		var finance_number=$("#finance_number").val();
		var finance_desc=$("#finance_desc").val();
		if(finance_name.trim().length==0){
			alert("请输入名称再进行提交");
			return false;
		}
		if(finance_price.trim().length==0){
			alert("请输入金额再进行提交");
			return false;
		}
		if(finance_number.trim().length==0){
			alert("请输入期数再进行提交");
			return false;
		}
		if(finance_desc.trim().length==0){
			alert("请输入描述再进行提交");
			return false;
		}
		$("#myForm").submit();
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="FinanceAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="名称" name="finance_name" id="finance_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="金额" name="finance_price" id="finance_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="期数" name="finance_number" id="finance_number" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="详情" name="finance_desc" id="finance_desc" value="">
										</div>
									</div>
								</div>
