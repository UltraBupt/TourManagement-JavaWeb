				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="TrainAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="起点" name="train_from" id="train_from" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="终点" name="train_to" id="train_to" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="金额" name="train_price" id="train_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="时间" name="train_time" id="train_time" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="机场" name="train_point" id="train_point" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="添加信息" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
