...
<script type="text/javascript">
	function toSub(){
		...
		if(partnerType_name.trim().length==0){
			alert("请输入供应商类型名称再进行提交");
			return false;
		}
		if(partnerType_desc.trim().length==0){
			alert("请输入供应商类型描述再进行提交");
			return false;
		}
...
<body>
		<div class="portlet box green ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> 新增供应商类型信息
				</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="PartnerTypeAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="供应商类型名称" name="partnerType_name" id="partnerType_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="供应商类型描述" name="partnerType_desc" id="partnerType_desc" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn green" value="添加会员类型" onclick="toSub()">添加</button>
								</div>
							</form>
