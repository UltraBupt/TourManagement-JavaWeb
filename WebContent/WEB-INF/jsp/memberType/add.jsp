				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增会员类型信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="MemberTypeAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="会员类型名称" name="memberType_name" id="memberType_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="会员升级次数" name="memberType_number" id="memberType_number" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="会员类型描述" name="memberType_desc" id="memberType_desc" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="会员类型折扣" name="memberType_benefit" id="memberType_benefit" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="添加会员类型" onclick="toSub()">添加</button>
								</div>
							</form>
