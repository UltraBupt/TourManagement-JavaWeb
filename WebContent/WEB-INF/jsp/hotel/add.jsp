				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="HotelAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="名称" name="hotel_name" id="hotel_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="金额" name="hotel_price" id="hotel_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="地址" name="hotel_address" id="hotel_address" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="详情" name="hotel_desc" id="hotel_desc" value="">
										</div>
									</div>
								</div>
