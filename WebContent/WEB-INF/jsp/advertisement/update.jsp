...
<script type="text/javascript">
	function toSub(){
		var advertisement_benefit=$("#advertisement_benefit").val();
		var advertisement_desc=$("#advertisement_desc").val();
		if(advertisement_benefit.trim().length==0){
			alert("广告收益不能为空，请重新输入");
			return false;
		}
		if(advertisement_desc.trim().length==0){
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 广告信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="AdvertisementUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="广告收益" name="advertisement_benefit" id="advertisement_benefit" value="${advertisement.advertisement_benefit }">
										</div>
									</div>
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="广告详情" name="advertisement_desc" id="advertisement_desc" value="${advertisement.advertisement_desc }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn red" value="编辑广告" onclick="toSub()">编辑广告</button>
									<input id="advertisement_id" name="advertisement_id" type="hidden" value="${advertisement.advertisement_id }"/>
								</div>
							</form>
