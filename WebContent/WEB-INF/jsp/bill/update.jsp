...
$(function(){
	 ...
	 $("input[name='bill_status']").each(function(){
		 if($(this).val()==bill_status){
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 修改状态
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="BillUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="radio-list">
											<label>
											<input type="radio" name="bill_status" id="bill_status" value="1"/>已处理 </label>
											<label>
											<input type="radio" name="bill_status" id="bill_status" value="0"/>未处理</label>
											<label>
											<input type="radio" name="bill_status" id="bill_status" value="-1"/>已删除 </label>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="bill_id" name="bill_id" type="hidden" value="${bill.bill_id }"/>
								</div>
							</form>
						</div>
					</div>
