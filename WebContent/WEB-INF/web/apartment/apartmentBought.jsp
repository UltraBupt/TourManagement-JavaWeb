          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="Apartment.html">公寓购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Apartment.html">公寓推荐</a></li>
            <li class="active">公寓购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet12.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${apartment.apartment_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${apartment.apartment_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${apartment.apartment_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${apartment.apartment_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${apartment.apartment_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${apartment.apartment_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
