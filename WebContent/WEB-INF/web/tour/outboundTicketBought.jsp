          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="OutboundTouristTicket.html">海外游景点门票</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet2.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${outboundTicket_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${outboundTicket_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${outboundTicket_desc }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${outboundTicket_price }元</strong>
                    </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${outboundTicket_desc }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${outboundTicket_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
