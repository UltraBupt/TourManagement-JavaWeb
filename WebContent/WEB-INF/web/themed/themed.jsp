        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${themed }" var="themed" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${themed.themed_url }" class="fancybox-button">
                    <img alt="" src="${themed.themed_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${themed.themed_price }元</div><br><br><br>
                  <center><p>${themed.themed_name}</p></center> 
                  <a href="ThemedBought.html?themed_id=${themed.themed_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
