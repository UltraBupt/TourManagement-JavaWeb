        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${hotel }" var="hotel" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${hotel.hotel_url }" class="fancybox-button">
                    <img alt="" src="${hotel.hotel_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${hotel.hotel_price }元</div><br><br><br>
                  <center><p>${hotel.hotel_name}</p></center> 
                  <a href="HotelBought.html?hotel_id=${hotel.hotel_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
