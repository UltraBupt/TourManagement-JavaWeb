          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="Financial.html">保险办理</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Financial.html">金融办理</a></li>
            <li class="active">分期购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet5.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${finance.finance_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${finance.finance_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${finance.finance_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${finance.finance_price }元</strong>
                    </div>
                    <div class="availability">
                      期数 <strong>${finance.finance_number }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${finance.finance_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${finance.finance_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
