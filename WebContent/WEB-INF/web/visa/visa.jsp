        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${visa }" var="visa" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${visa.visa_url }" class="fancybox-button">
                    <img alt="" src="${visa.visa_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${visa.visa_price }元</div><br><br><br>
                  <center><p>${visa.visa_address}</p></center> 
                  <a href="VisaBought.html?visa_id=${visa.visa_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
