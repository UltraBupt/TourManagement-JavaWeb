      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet4.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${visa.visa_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${visa.visa_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  地点<h1>${visa.visa_address }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${visa.visa_price }元</strong>
                    </div>
                    <div class="availability">
                      办理天数 <strong>${visa.visa_date }天</strong><br>
                      有效期 <strong>${visa.visa_useful }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${visa.visa_address }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${visa.visa_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
