          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="QuickMeal.html">快餐购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="QuickMeal.html">快餐推荐</a></li>
            <li class="active">快餐购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet7.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${quick.quick_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${quick.quick_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${quick.quick_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${quick.quick_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${quick.quick_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${quick.quick_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${quick.quick_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
