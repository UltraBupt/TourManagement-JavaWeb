          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="HolidayInn.html">假日酒店购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="HolidayInn.html">假日酒店推荐</a></li>
            <li class="active">假日酒店购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet11.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${holiday.holiday_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${holiday.holiday_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${holiday.holiday_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${holiday.holiday_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${holiday.holiday_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${holiday.holiday_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${holiday.holiday_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
