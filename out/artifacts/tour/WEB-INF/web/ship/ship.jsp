        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${ship }" var="ship" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${ship.ship_url }" class="fancybox-button">
                    <img alt="" src="${ship.ship_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${ship.ship_price }元</div><br><br><br>
                  <center><p>起点 ${ship.ship_from}</p>
                  		  <p>终点 ${ship.ship_to}</p>
                  </center> 
                  <a href="ShipBought.html?ship_id=${ship.ship_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
