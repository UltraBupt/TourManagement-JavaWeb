          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="QuickHotel.html">快捷酒店购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="QuickHotel.html">快捷酒店推荐</a></li>
            <li class="active">快捷酒店购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet15.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${hotel.hotel_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${hotel.hotel_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${hotel.hotel_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${hotel.hotel_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${hotel.hotel_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${hotel.hotel_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
