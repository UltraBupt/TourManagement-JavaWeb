          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="fasterTicket.html">动车票购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="fasterTicket.html">动车票推荐</a></li>
            <li class="active">动车票购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet20.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${faster.faster_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${faster.faster_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${faster.faster_point }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${faster.faster_price }元</strong>
                    </div>
                    <div class="availability">
                      起点  <strong>${faster.faster_from }</strong><br>
                       终点  <strong>${faster.faster_to }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${faster.faster_point }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${faster.faster_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <input type="button" value="购买" class="btn btn-primary" onclick="toSub()">
                </div>
				</form>
				 起飞时间 ${faster.faster_time }
