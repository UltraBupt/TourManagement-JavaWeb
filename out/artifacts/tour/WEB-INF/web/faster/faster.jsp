        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${faster }" var="faster" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${faster.faster_url }" class="fancybox-button">
                    <img alt="" src="${faster.faster_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${faster.faster_price }元</div><br><br><br>
                  <center><p>起点 ${faster.faster_from}</p>
                  		  <p>终点 ${faster.faster_to}</p>
                  </center> 
                  <a href="FasterBought.html?faster_id=${faster.faster_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
