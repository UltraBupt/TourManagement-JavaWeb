            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  ...
                  <form class="form-horizontal form-without-legend" id="myForm" action="WebLoginServlet.html" method="post">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                        <input  class="btn btn-primary" type="button" value="登录" onclick="toSub()">
                      </div>
                    </div>
                  </form>
