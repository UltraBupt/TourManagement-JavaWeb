          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="Snack.html">小吃购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Snack.html">小吃推荐</a></li>
            <li class="active">小吃购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet6.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${snack.snack_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${snack.snack_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${snack.snack_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${snack.snack_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${snack.snack_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${snack.snack_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
