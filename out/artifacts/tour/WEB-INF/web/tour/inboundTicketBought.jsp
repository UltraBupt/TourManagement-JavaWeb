          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="InboundTouristTicket.html">国内游景点门票</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet1.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${inboundTicket_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${inboundTicket_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${inboundTicket_desc }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${inboundTicket_price }元</strong>
                    </div>
                    <div class="availability">
                      晨曦旅行 <strong>享受生活</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${inboundTicket_desc }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${inboundTicket_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
