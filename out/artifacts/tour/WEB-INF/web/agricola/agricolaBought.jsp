          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="Agricola.html">农家乐购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Agricola.html">农家乐推荐</a></li>
            <li class="active">农家乐购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet14.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${agricola.agricola_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${agricola.agricola_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${agricola.agricola_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${agricola.agricola_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${agricola.agricola_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${agricola.agricola_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${agricola.agricola_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
