...
<script type="text/javascript">
	function toSub(){
		var aroundTicket_desc=$("#aroundTicket_desc").val();
		var aroundTicket_price=$("#aroundTicket_price").val();
		if(aroundTicket_desc.trim().length==0){
			alert("门票详情不能为空，请重新输入");
			return false;
		}
		if(aroundTicket_price.trim().length==0){
				...
				<div class="caption">
					<i class="fa fa-gift"></i>景点门票编辑
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="AroundTicketUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="门票描述" name="aroundTicket_desc" id="aroundTicket_desc" value="${aroundTicket.aroundTicket_desc }">
										</div>
									</div>
								</div>
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="门票价格" name="aroundTicket_price" id="aroundTicket_price" value="${aroundTicket.aroundTicket_price }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="aroundTicket_id" name="aroundTicket_id" type="hidden" value="${aroundTicket.aroundTicket_id }"/>
								</div>
							</form>
						</div>
					</div>
