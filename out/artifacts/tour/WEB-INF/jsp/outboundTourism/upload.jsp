...
<script type="text/javascript">
	function toSub(){
		var outboundTourism_url=$("#outboundTourism_url").val();
		if(outboundTourism_url.trim().length==0){
			alert("请选择图片再进行提交");
		}else{
			$("#myForm").submit();
		}
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 上传
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="OutboundTourismUploadServlet.shxt" method="post" id="myForm" enctype="multipart/form-data">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													...
													<span class="fileinput-new">
														<input class="btn default btn-file" type="file" name="outboundTourism_url" id="outboundTourism_url" placeholder="请选择图片">
														<input type="hidden" name="outboundTourism_id" value="${outboundTourism_id }">
													</span>
													</span>
												</div>
											</div>
								...
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="上传图像" onclick="toSub()">上传图片</button>
								</div>
							</form>
