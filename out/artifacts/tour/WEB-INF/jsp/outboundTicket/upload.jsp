...
<script type="text/javascript">
	function toSub(){
		var outboundTicket_url=$("#outboundTicket_url").val();
		if(outboundTicket_url.trim().length==0){
			alert("请选择图片再进行提交");
		}else{
			$("#myForm").submit();
		}
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 上传
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="OutboundTicketUploadServlet.shxt" method="post" id="myForm" enctype="multipart/form-data">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													...
													<span class="fileinput-new">
														<input class="btn default btn-file" type="file" name="outboundTicket_url" id="outboundTicket_url" placeholder="请选择图片">
														<input type="hidden" name="outboundTicket_id" value="${outboundTicket_id }">
													</span>
													</span>
												</div>
											</div>
