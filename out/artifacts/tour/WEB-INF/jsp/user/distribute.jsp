				...
				<div class="caption">
					<i class="fa fa-gift"></i> 分配角色
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="UserDistributeServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="col-md-4" style="height:150px">
											<input id="user_id" name="user_id" type="hidden" value="${user.user_id }"/>
											<select name="fk_role_id" id="fk_role_id" class="form-control input-xlarge select2me" data-placeholder="请选择要分配的角色">
												<option value="">全部</option>
												<c:forEach items="${role_list }" var="role">
													<option value="${role.role_id }"
														<c:if test="${user.fk_role_id==role.role_id }">selected</c:if>
								...
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="分配" onclick="toSub()">分配</button>
								</div>
							</form>
