...
<script type="text/javascript">
	function toSub(){
		var inboundTourism_url=$("#inboundTourism_url").val();
		if(inboundTourism_url.trim().length==0){
			alert("请选择图片再进行提交");
		}else{
			$("#myForm").submit();
		}
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 上传
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="InboundTourismUploadServlet.shxt" method="post" id="myForm" enctype="multipart/form-data">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													...
													<span class="fileinput-new">
														<input class="btn default btn-file" type="file" name="inboundTourism_url" id="inboundTourism_url" placeholder="请选择图片">
														<input type="hidden" name="inboundTourism_id" value="${inboundTourism_id }">
													</span>
													</span>
												</div>
											</div>
