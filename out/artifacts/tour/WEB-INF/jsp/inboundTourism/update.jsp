...
<script type="text/javascript">
	function toSub(){
		var inboundTourism_desc=$("#inboundTourism_desc").val();
		if(inboundTourism_desc.trim().length==0){
				...
				<div class="caption">
					<i class="fa fa-gift"></i>热门景点编辑
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="InboundTourismUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="景点描述" name="inboundTourism_desc" id="inboundTourism_desc" value="${inboundTourism.inboundTourism_desc }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="inboundTourism_id" name="inboundTourism_id" type="hidden" value="${inboundTourism.inboundTourism_id }"/>
								</div>
							</form>
						</div>
					</div>
