...
<script type="text/javascript">
	function toSub(){
		...
		if(salary_number.trim().length==0){
			alert("薪资不能为空，请重新输入");
			return false;
		}else{
			$("#myForm").submit();
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 薪资信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="SalaryUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="职位" name="position_name" id="position_name" value="${salary.position_name }" disabled="disabled">
										</div>
									</div>
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="薪资" name="salary_number" id="salary_number" value="${salary.salary_number }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn red" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="salary_id" name="salary_id" type="hidden" value="${salary.salary_id }"/>
								</div>
							</form>
