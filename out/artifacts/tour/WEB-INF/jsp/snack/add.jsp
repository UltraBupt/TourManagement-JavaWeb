				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="SnackAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="名称" name="snack_name" id="snack_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="金额" name="snack_price" id="snack_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="地址" name="snack_address" id="snack_address" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="详情" name="snack_desc" id="snack_desc" value="">
										</div>
									</div>
								</div>
