      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet3.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${insurance.insurance_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${insurance_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${insurance.insurance_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${insurance.insurance_price }元</strong>
                    </div>
                    <div class="availability">
                      保额 <strong>${insurance.insurance_maxPrice }元</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${insurance.insurance_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${insurance.insurance_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
