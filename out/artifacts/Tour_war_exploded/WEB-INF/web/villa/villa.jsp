        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${villa }" var="villa" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${villa.villa_url }" class="fancybox-button">
                    <img alt="" src="${villa.villa_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${villa.villa_price }元</div><br><br><br>
                  <center><p>${villa.villa_name}</p></center> 
                  <a href="VillaBought.html?villa_id=${villa.villa_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
