          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="Villa.html">别墅购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="Villa.html">别墅推荐</a></li>
            <li class="active">别墅购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet13.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${villa.villa_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${villa.villa_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${villa.villa_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${villa.villa_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${villa.villa_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${villa.villa_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${villa.villa_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
