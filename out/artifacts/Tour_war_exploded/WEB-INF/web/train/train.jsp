        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${train }" var="train" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${train.train_url }" class="fancybox-button">
                    <img alt="" src="${train.train_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${train.train_price }元</div><br><br><br>
                  <center><p>起点 ${train.train_from}</p>
                  		  <p>终点 ${train.train_to}</p>
                  </center> 
                  <a href="TrainBought.html?train_id=${train.train_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
