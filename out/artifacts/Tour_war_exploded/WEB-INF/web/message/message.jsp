...
<body class="corporate">
            ...
            <div class="content-page">
              <div class="row">
                <div class="col-md-9 col-sm-9">
                  ...
                  <form id="myForm" action="NewMessage.html" method="post">
                    <div class="form-group">
                      <textarea class="form-control" rows="10" id="newMessage" name="newMessage"></textarea>
                    </div>
                     <input  class="btn btn-primary" type="button" value="提交" onclick="toSub()"><br/>
                ...
                <div class="col-md-3 col-sm-3 sidebar2">
                  ...
                  <h2 class="padding-top-30">我们的理念</h2>
    ...
    <script src="resource/assets/global/plugins/gmaps/gmaps.js" type="text/javascript"></script>
    <script src="resource/assets/frontend/pages/scripts/contact-us.js" type="text/javascript"></script>
