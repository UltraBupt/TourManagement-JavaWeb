        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${bus }" var="bus" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${bus.bus_url }" class="fancybox-button">
                    <img alt="" src="${bus.bus_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${bus.bus_price }元</div><br><br><br>
                  <center><p>起点 ${bus.bus_from}</p>
                  		  <p>终点 ${bus.bus_to}</p>
                  </center> 
                  <a href="BusBought.html?bus_id=${bus.bus_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
