          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="content-page">
              <div class="row margin-bottom-30">
                <div class="col-md-7">
                  <h2 class="no-top-space">关于晨曦旅行</h2>
                  <p>晨曦旅行是中国领先的无线和在线旅游平台，其网站上线于2008年，公司总部位于济南。晨曦旅行致力于建立一个为整个旅游业价值链服务的生态系统，并通过科技来改变人们的旅行方式。晨曦旅行通过其自有技术平台有效匹配旅游业的供需，满足旅游服务供应商和中国旅行者的需求。对旅游服务供应商而言，晨曦旅行通过移动客户端及在线平台为其提供技术基础设施；对旅行者而言，晨曦旅行通过网站及移动客户端的全平台覆盖，随时随地为其提供国内外机票、酒店、度假、旅游团购、及旅行信息的深度搜索，帮助旅行者找到性价比较高的产品、较优质的信息和便捷的预订方式，聪明地安排旅行。</p>
				  <p>根据2014年9月艾瑞监测数据，在旅行类网站月度独立访问量统计中，晨曦旅行以4474万人名列前茅。截至2015年3月31日，晨曦旅行可实时搜索约9，000家旅游代理商网站，搜索范围覆盖全球范围内超过28万条国内及国际航线、约103万家酒店、85万余条度假线路、近万个旅游景点，并且每日提供超过20万种旅游团购产品。晨曦旅行移动客户端“晨曦旅行”是中国旅行类较受欢迎的移动应用，截至第一季度末拥有超过8亿的激活下载量。根据中国互联网络信息中心（CNNIC）发布的《2012年中国网民在线旅行预订行为调查报告》，晨曦旅行是手机旅行信息查询用户安装和使用较多的移动客户端。</p>
                  <div class="row front-lists-v1">
                    <div class="col-md-6">
                      <ul class="list-unstyled margin-bottom-20">
                        <li><i class="fa fa-check"></i> 方便</li>
                        <li><i class="fa fa-check"></i> 安全</li>
                        <li><i class="fa fa-check"></i> 实惠</li>
                      </ul>
                    </div>
                    <div class="col-md-6">
                      <ul class="list-unstyled">
                        <li><i class="fa fa-check"></i> 无忧</li>
                        <li><i class="fa fa-check"></i> 快乐</li>
                        <li><i class="fa fa-check"></i> 完美</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="myCarousel" class="carousel slide">
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="resource/assets/frontend/pages/img/pics/1.jpg" alt="">
                        <div class="carousel-caption">
                        	<p>公司环境</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="resource/assets/frontend/pages/img/pics/2.jpg" alt="">
                        <div class="carousel-caption">
                          <p>公司位置</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="resource/assets/frontend/pages/img/pics/3.jpg" alt="">
                        <div class="carousel-caption">
                          <p>济南大学</p>
                        </div>
                      </div>
