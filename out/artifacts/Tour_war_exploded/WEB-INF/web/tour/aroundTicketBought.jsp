          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="AroundTouristTicket.html">周围景点门票</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${aroundTicket_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${aroundTicket_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${aroundTicket_desc }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${aroundTicket_price }元</strong>
                    </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${aroundTicket_desc }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${aroundTicket_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
