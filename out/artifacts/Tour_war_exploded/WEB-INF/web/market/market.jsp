                  ...
                  <div id="myCarousel1" class="carousel slide">
                    <div class="carousel-inner">
                      <div class="active item">
                        <blockquote><p>一方面，由于晨曦旅行自身技术和产品上的优势，另一方面，在线旅游无疑是中国互联网最炙手可热的领域，也是潜力最大的领域。
“晨曦旅行 ”认识到在线旅游市场的用户需求已经逐渐变化：中立、智能、全面的比较平台，对用户进行旅游产品选择和决策的作用日渐突出。正是这种需求的增长，促使了公正、中立的旅游新媒体“晨曦旅行”的出现，并凭借其便捷、人性且先进的搜索技术，对互联网上的机票、酒店、度假和签证等信息进行整合，为用户提供及时的旅游产品价格查询和比较服务</p></blockquote>
                      </div>
                    </div>
                  </div>
                </div>
