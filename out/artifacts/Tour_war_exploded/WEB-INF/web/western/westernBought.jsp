    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="WesternRestaurant.html">西式推荐</a></li>
            <li class="active">西式购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet10.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${western.western_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${western.western_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${western.western_name }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${western.western_price }元</strong>
                    </div>
                    <div class="availability">
                      地址 <strong>${western.western_address }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${western.western_name }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${western.western_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
