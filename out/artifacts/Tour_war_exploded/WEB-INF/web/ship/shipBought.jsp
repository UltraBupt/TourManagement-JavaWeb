          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="ShipTicket.html">轮船票购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="ShipTicket.html">轮船票推荐</a></li>
            <li class="active">轮船票购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet18.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${ship.ship_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${ship.ship_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${ship.ship_point }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${ship.ship_price }元</strong>
                    </div>
                    <div class="availability">
                      起点  <strong>${ship.ship_from }</strong><br>
                       终点  <strong>${ship.ship_to }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${ship.ship_point }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${ship.ship_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
