        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12">
            ...
            <div class="content-page">
              ...
              <c:forEach items="${airline }" var="airline" varStatus="vs">
                <div class="col-md-3 col-sm-4 gallery-item">
                  <a data-rel="fancybox-button" title="Project Name" href="${airline.airline_url }" class="fancybox-button">
                    <img alt="" src="${airline.airline_url }" class="img-responsive">
                    <div class="zoomix"><i class="fa fa-search"></i></div>
                  </a>
                  <div class="pi-price">${airline.airline_price }元</div><br><br><br>
                  <center><p>起点 ${airline.airline_from}</p>
                  		  <p>终点 ${airline.airline_to}</p>
                  </center> 
                  <a href="AirlineBought.html?airline_id=${airline.airline_id }"><input type="button" value="购买" class="btn btn-circle " onclick="toSub()"></a>
                </div>
               </c:forEach> 
