          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="AirlineTicket.html">机票购买</a></li>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="AirlineTicket.html">机票推荐</a></li>
            <li class="active">机票购买</li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-9 col-sm-7">
            ...
            <form action="WebBillListServlet16.html" method="post" id="myForm">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${airline.airline_url }" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${airline.airline_url }">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1>${airline.airline_point }</h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong>${airline.airline_price }元</strong>
                    </div>
                    <div class="availability">
                      起点  <strong>${airline.airline_from }</strong><br>
                       终点  <strong>${airline.airline_to }</strong>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="bill_thing" id="bill_thing" value="${airline.airline_point }">
                   <input type="hidden" name="bill_price" id="bill_price" value="${airline.airline_price }">
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <input type="button" value="购买" class="btn btn-primary" onclick="toSub()">
                </div>
				</form>
				 起飞时间 ${airline.airline_time }
