            ...
            <div class="content-page">
              ...
              <div class="row front-team">
                <ul class="list-unstyled">
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="resource/assets/frontend/pages/img/me1/people3s.jpg">
                      <h3>
                        <strong>升哥</strong> 
                        <small>CEO</small>
                      </h3>
                      <p>晨曦旅行自08年成立至今，感谢大家的一路支持。我们当竭尽全力为大家提供最一流的服务，最优惠的价格，给您带来最美好的体验，你与自然只缺一个晨曦。</p>
                    </div>
                  </li>
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="resource/assets/frontend/pages/img/me1/people1s.jpg">
                      <h3>
                        <strong>萌总</strong> 
                        <small>销售总监</small>
                      </h3>
                      <p>思念像一首诗，如春之暮野，在春日的阳光中我们卸下沉重的包袱，与家人一起沐浴晨曦，拥抱自然。</p>
                    </div>
                  </li>
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="resource/assets/frontend/pages/img/me1/people2s.jpg">
                      <h3>
                        <strong>帅总</strong> 
                        <small>HR</small>
                      </h3>
                      <p>在晨曦的每个日夜都是那么美好，每天充实而又安逸，欢迎加入我们，晨曦旅行为您服务。</p>
                    </div>
                  </li>
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="resource/assets/frontend/pages/img/people/img5-large.jpg">
                      <h3>
                        <strong>爱丽丝</strong> 
                        <small>市场策划</small>
                      </h3>
                      <p>中国是个美丽的地方，晨曦与我同在</p>
                    </div>
                  </li>
                </ul>            
              </div>
