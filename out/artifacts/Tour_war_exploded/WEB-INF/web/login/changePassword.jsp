	    	...
	    	function toChange(){
		      	...
		      	if(old_password==0){
				    ...
				    return false;
		    	  	...
		    	  	$.post("ChangePasswordCheck.html",{old_password:old_password},function(data){
        ...
        <div class="row margin-bottom-40">
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="WebLoginServlet.html"><i class="fa fa-angle-right"></i> 登录</a></li>
              <li class="list-group-item clearfix"><a href="WebChangePasswordServlet.html"><i class="fa fa-angle-right"></i> 修改密码</a></li>
              <li class="list-group-item clearfix"><a href="WebMyselfInformationServlet.html"><i class="fa fa-angle-right"></i> 个人信息查看</a></li>
            </ul>
          </div>
            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  ...
                  <form class="form-horizontal form-without-legend" id="myForm" action="WebChangePasswordServlet.html" method="post">
                    <div class="form-group">
                      <label class="col-lg-4 control-label">请输入原密码 <span class="require">*</span></label>
                      <div class="col-lg-8">
                      	<input type="text" class="form-control" id="old_password" name="old_password" onchange="toChange()"><i id="old_message"></i>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-4 control-label">请输入新密码 <span class="require">*</span></label>
                      <div class="col-lg-8">
                        <input type="password" class="form-control" id="new_password" name="new_password" disabled="disabled" style="background: #CCC;"><i id="new_message"></i>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-4 control-label">请确认密码 <span class="require">*</span></label>
                      <div class="col-lg-8">
                        <input type="password" class="form-control" id="re_password" name="re_password" disabled="disabled"  style="background: #CCC;" ><i id="re_message"></i>
                      </div>
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                        <input  class="btn btn-primary" type="button" value="修改" onclick="toSub()">
                      </div>
                    </div>
                  </form>
