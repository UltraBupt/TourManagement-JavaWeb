            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  ...
                  <form class="form-horizontal form-without-legend" id="myForm" action="WebMyselfInformationServlet.html" method="post">
                    <div class="form-group">
                      <label class="col-lg-4 control-label">消费次数 <span class="require">*</span></label>
                      <div class="col-lg-8">
                        <input type="text" class="form-control" id="member_number" name="member_number" value="${member.member_number }" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-4 control-label">会员类型 <span class="require">*</span></label>
                      <div class="col-lg-8">
                        <input type="text" class="form-control" id="member_type" name="member_type" value="${member.member_type }" readonly="readonly">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-4 control-label">会员折扣 <span class="require">*</span></label>
                      <div class="col-lg-8">
                        <input type="text" class="form-control" id="member_benefit" name="member_benefit" value="${member.member_benefit }" readonly="readonly">
                      </div>
                    </div>
                  </form>
