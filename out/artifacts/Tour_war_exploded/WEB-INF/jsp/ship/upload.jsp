...
<script type="text/javascript">
	function toSub(){
		var ship_url=$("#ship_url").val();
		if(ship_url.trim().length==0){
			alert("请选择图片再进行提交");
		}else{
			$("#myForm").submit();
		}
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 上传
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="ShipUploadServlet.shxt" method="post" id="myForm" enctype="multipart/form-data">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													...
													<span class="fileinput-new">
														<input class="btn default btn-file" type="file" name="ship_url" id="ship_url" placeholder="请选择图片">
