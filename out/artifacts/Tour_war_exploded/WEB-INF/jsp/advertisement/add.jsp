				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增广告
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="AdvertisementAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="广告收益" name="advertisement_benefit" id="advertisement_benefit" value="">
										</div>
									</div>
								</div>
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="广告内容" name="advertisement_desc" id="advertisement_desc" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<input type="hidden" name="advertisement_id" id="advertisement_id" value="${advertisement.advertisement_id }">
									<button type="button" class="btn red" value="添加广告" onclick="toSub()">添加广告</button>
								</div>
							</form>
