...
<script type="text/javascript">
	function toSub(){
		...
		$.post("CheckRole.shxt",{fk_role_id:fk_role_id},function(data){
			if(data.flg){
				$("#myForm").submit();
			}else{
				alert(data.message);
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增薪资信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="SalaryAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
										<div class="col-md-4" style="height:150px">
											<select name="fk_role_id" id="fk_role_id" class="form-control input-xlarge select2me" data-placeholder="请选择角色">
									...
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="薪资" name="salary_number" id="salary_number" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn red" value="添加薪资" onclick="toSub()">添加</button>
								</div>
							</form>
