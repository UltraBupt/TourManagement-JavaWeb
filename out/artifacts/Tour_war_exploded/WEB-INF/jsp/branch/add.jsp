				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增部门信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="BranchAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="部门名称" name="branch_name" id="branch_name" value="">
										</div>
									</div>
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="部门描述" name="branch_desc" id="branch_desc" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn green" value="添加部门" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
