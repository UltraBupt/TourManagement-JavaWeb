...
<script type="text/javascript">
	function toSub(){
		...
		var holiday_price=$("#holiday_price").val();
		var holiday_address=$("#holiday_address").val();
		var holiday_desc=$("#holiday_desc").val();
		if(holiday_name.trim().length==0){
			alert("请输入名称再进行提交");
			return false;
		}
		if(holiday_price.trim().length==0){
			alert("请输入金额再进行提交");
			return false;
		}
		if(holiday_address.trim().length==0){
			alert("请输入地址再进行提交");
			return false;
		}
		if(holiday_desc.trim().length==0){
			alert("请输入描述再进行提交");
			return false;
		}
		$("#myForm").submit();
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="HolidayAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="名称" name="holiday_name" id="holiday_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="金额" name="holiday_price" id="holiday_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="地址" name="holiday_address" id="holiday_address" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="详情" name="holiday_desc" id="holiday_desc" value="">
										</div>
									</div>
								</div>
