			...
			<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								<form action="LoginListServlet.shxt" method="post" id="myForm">
									<input type="text" name="login_record_name" id="login_record_name" value="${queryLoginRecord.login_record_name }" placeholder="请输入姓名" maxlength="15">
									<input type="text" name="login_record_account" id="login_record_account" value="${queryLoginRecord.login_record_account }" placeholder="请输入账号" maxlength="15">
								...
								<c:forEach items="${pageBean.data }" var="loginRecord" varStatus="vs">
									<tr class="active">
									<td style="width: 84px; height: 84px">
										 ${vs.count+(pageBean.pageNow-1)*pageBean.pageSize }
									</td>
									<td>
										 ${loginRecord.login_record_name }
									</td>
									<td>
										 ${loginRecord.login_record_create_date }
									</td>
									<td>
										 ${loginRecord.login_record_account }
									</td>
								</tr>
								</c:forEach>
								</tbody>
