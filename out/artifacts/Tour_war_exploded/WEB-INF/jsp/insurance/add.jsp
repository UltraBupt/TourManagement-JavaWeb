				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增保单信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="InsuranceAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="价格" name="insurance_price" id="insurance_price" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="名称" name="insurance_name" id="insurance_name" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="number" class="form-control input-sm" placeholder="保额" name="insurance_maxPrice" id="insurance_maxPrice" value="" >
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="保单详情" name="insurance_desc" id="insurance_desc" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="添加保险信息" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
