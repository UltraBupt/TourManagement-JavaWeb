...
<script type="text/javascript">
	function toSub(){
		var aroundTourism_desc=$("#aroundTourism_desc").val();
		if(aroundTourism_desc.trim().length==0){
				...
				<div class="caption">
					<i class="fa fa-gift"></i>热门景点编辑
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="AroundTourismUpdateServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="景点描述" name="aroundTourism_desc" id="aroundTourism_desc" value="${aroundTourism.aroundTourism_desc }">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn blue" value="修改信息" onclick="toSub()">修改信息</button>
									<input id="aroundTourism_id" name="aroundTourism_id" type="hidden" value="${aroundTourism.aroundTourism_id }"/>
								</div>
							</form>
						</div>
					</div>
