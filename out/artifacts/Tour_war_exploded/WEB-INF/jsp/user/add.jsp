...
<script type="text/javascript">
	function toSub(){
		...
		$.post("CheckAccountServlet.shxt",{account:account},function(data){
			if(data.flg){
				$("#myForm").submit();
			}else{
				alert(data.message);
				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增用户信息
						...
						<div class="portlet-body form">
							<form class="form-horizontal" action="UserAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="账号" name="account" id="account" value="">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="密码" name="password" id="password" value="123456" readonly>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="姓名" name="user_name" id="user_name" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="reset" class="btn blue">重置</button>
									<button type="button" class="btn blue" value="添加员工" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
