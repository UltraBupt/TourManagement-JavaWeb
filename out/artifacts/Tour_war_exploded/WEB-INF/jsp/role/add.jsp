				...
				<div class="caption">
					<i class="fa fa-gift"></i> 新增角色信息
						...
						<div class="portlet-body form">
							...
							<form class="form-horizontal" action="RoleAddServlet.shxt" method="post" id="myForm">
								<div class="form-body">
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="角色名称" name="role_name" id="role_name" value="">
										</div>
									</div>
									<div class="form-group" style="height:50px">
										<div class="col-md-9">
											<input type="text" class="form-control input-sm" placeholder="角色描述" name="role_desc" id="role_desc" value="">
										</div>
									</div>
								</div>
								<div class="form-actions right1">
									<button type="button" class="btn red" value="添加角色" onclick="toSub()">添加</button>
								</div>
							</form>
						</div>
					</div>
